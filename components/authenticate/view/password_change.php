...
<?php  	if(!isset($_GET['message'])){  print '<p class="tip">Password Change Form</p>';
...
?>     
    	  <form method="post" action="index.php?components=authenticate&action=change_password" onsubmit="return validateNewPassword()">
    	    ...
    	    <p><label><strong>Confirm Password</strong><input class="inputText" id="user_pass2" type="password" /></label></p>
      	    <input class="black_button" value="Change Password" style="width: 111px;" type="submit" />
      	    <br /><br />
    	  </form>
    	</div>
        <div id="forgot">
        <a href="index.php?components=dashboard&action=home" class="forgotlink"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Go Back to HOME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
        </div>
  </div>
</div>
<br clear="all">
